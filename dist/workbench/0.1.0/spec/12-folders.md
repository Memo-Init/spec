...
| `.browser/` | Optional | Project | — | — | Browser-automation session, scripts, and output — only when the project does browser automation; legacy alias `.playwright/` (see [31-browser-automation.md](/workbench/browser-automation/)). |
