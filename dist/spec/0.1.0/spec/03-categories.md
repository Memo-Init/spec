...
generated_from: "draft/spec/0.1.0/spec/03-categories.md"
generator: "scripts/generate-docs-payload.mjs"
edit_warning: "This file is auto-generated. Source: draft/spec/0.1.0/spec/03-categories.md."
---
...
The family manifest ([Per-Chapter Format](/specification/per-chapter-format/)) carries a `groups[]` array. Each group is a category of chapters:
...
| Bridge hub | Groups its per-chapter coverage blocks under the same category headings, mirroring the sidebar ([The Bridge Standard](/specification/bridge-standard/)). |
...
- [./02-per-chapter-format.md](/specification/per-chapter-format/) — the family head that carries the `groups[]` array.
- [./04-bridge-standard.md](/specification/bridge-standard/) — the bridge hub that mirrors these categories in its coverage view.
- [./00-overview.md](/specification/overview/) — the meta-specification entry point.
