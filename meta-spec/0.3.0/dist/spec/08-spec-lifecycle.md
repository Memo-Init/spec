...
generated_from: "meta-spec/0.3.0/draft/spec/08-spec-lifecycle.md"
generator: "scripts/generate-docs-payload.mjs"
edit_warning: "This file is auto-generated. Source: meta-spec/0.3.0/draft/spec/08-spec-lifecycle.md."
---
...
**Emit precondition.** The spec side MUST **emit** the llms bundle before the site can pass it through. flowmcp (`generated/llms.txt`) and personal-brand (`dist/<ns>/llms.txt`) already emit it; memo-init `repos/spec` currently emits none and MUST restore emission before its site can pass a bundle through.
...
The detection machinery is **not** newly built: the drift engine already exists (`DriftSensor`) and is **lifted** onto the spec edges — reused as-is, not reinvented.
