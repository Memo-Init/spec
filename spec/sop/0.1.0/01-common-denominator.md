...
Every SOP in the system provides the same four parts. This chapter defines them. An SOP **MUST** make each of the three core parts findable, and **MAY** add scope-specific extras. The four parts are the predictable shape on which the [SOP overview](./00-overview.md) rests.
