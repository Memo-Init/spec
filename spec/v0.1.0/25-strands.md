...
- **The flow.** A memo's **topics** are merged into **PRDs**; PRDs are sequenced into **phases**; phases and PRDs, ordered by their dependencies, form a **path** — and that path is a strand. (Topics → PRDs → Phases, per [08-phases-and-prds.md](./08-phases-and-prds.md).)
