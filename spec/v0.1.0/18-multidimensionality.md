...
- The reason for the restriction is **context**: a memo that reaches across projects blurs the context it is reasoning in, and a blurred context is the precondition for contamination (see [13-orchestration.md](./13-orchestration.md) and the context-rot model). Keeping coordination project-internal keeps the context sharp.
