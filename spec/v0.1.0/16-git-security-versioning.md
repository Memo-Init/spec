...
- **Memo-ID referenced** — the issue references its work package by memo ID (`M{NNN}-{PP}` for a phase), so the trail is searchable (see [17-git-workflow-and-ids.md](./17-git-workflow-and-ids.md)).
