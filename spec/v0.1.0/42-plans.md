...
- [./30-primitives.md](./30-primitives.md) — the eleven primitives, of which the plan is the one that spans many memos.
- [./08-phases-and-prds.md](./08-phases-and-prds.md) — phases, PRDs, and the `## Phase-Hints` table a plan reads for next-phase resolution.
- [./12-rollout.md](./12-rollout.md) — the rollout that a plan sequences across memos.
