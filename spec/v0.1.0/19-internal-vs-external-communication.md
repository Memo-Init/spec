...
- **Mixed-language labels** — a label in the inward working language placed on a page written in the outward publication language. One language per artifact (see [00-overview.md](./00-overview.md)); a stray inward-language label reads as insider noise.
