...
- [08-phases-and-prds.md](./08-phases-and-prds.md) — the `## Phase-Hints` dependency tree from which the topological PRD-prompt order is derived.
- [32-prompt-governance.md](./32-prompt-governance.md) — the governance that keeps this engine the sole, untouched prompt producer.
