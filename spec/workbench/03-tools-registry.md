...
| Related | [02-requirements.md](./02-requirements.md), [04-strands.md](./04-strands.md), [00-overview.md](./00-overview.md) |
...
- The checklist makes tool reachability a planning-time concern. Combined with the workbench-level tool-reachability check (see [00-overview.md](./00-overview.md)), a memo can confirm its required tools resolve *before* the rollout assumes them.
- Per-strand tool selections (see [04-strands.md](./04-strands.md)) draw from this same registry, so each strand can declare the tools it needs.
...
- [01-project-structure.md](./01-project-structure.md) — the `.memo/tools/` location.
- [02-requirements.md](./02-requirements.md) — the enforced data sibling, contrasted with this recommended one.
- [04-strands.md](./04-strands.md) — strands draw per-strand tools from this registry.
- [00-overview.md](./00-overview.md) — the workbench-level tool-reachability check.
