...
- [12-folders.md](./12-folders.md) — now home to the registered-folders, conventions, and add-on diagram.
- [25-validation-overview.md](./25-validation-overview.md) — now home to the before/after validation-boundary diagram.
- [20-cli.md](./20-cli.md) — now home to the session-validation hand-off diagram (Memo collects, Workbench builds).
- [24-skills-scope.md](./24-skills-scope.md) — now home to the signpost-cascade and orchestrator/component diagram.
- [23-hooks-contract.md](./23-hooks-contract.md) — the pre-hook half of the validation boundary.
- [26-addons.md](./26-addons.md) — the add-on model the folders diagram references.
