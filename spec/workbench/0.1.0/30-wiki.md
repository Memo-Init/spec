...
| **DESIGN.md** | the design convention — a project's design intent and decisions in prose | [18-design.md](./18-design.md) |
...
- [18-design.md](./18-design.md) — `DESIGN.md`, the design convention; a storage format the wiki reads through.
