...
generated_from: "spec/workbench/0.1.0/draft/spec/18-design.md"
generator: "scripts/generate-docs-payload.mjs"
edit_warning: "This file is auto-generated. Source: spec/workbench/0.1.0/draft/spec/18-design.md."
---
...
The folder is a registered, optional entry in the contract ([12-folders.md](/workbench/folders/)); a project adds it when it does design work and omits it otherwise.
...
- **The `.pen` files, HTML, and screenshots are the reference** — the concrete *visuals* that show the system applied. Captured view proofs live in `proofs/` ([12-folders.md](/workbench/folders/)).
...
- **Checked on write.** A write-time lint can validate a design.md against the convention (its frontmatter and required sections) at the moment it is written, the same mechanism applied to other folders' content ([23-hooks-contract.md](/workbench/hooks-contract/)).
- **Findable.** The wiki indexes `design/` among the project's domains, so the design system is discoverable alongside everything else ([30-wiki.md](/workbench/wiki/)).
...
- [12-folders.md](/workbench/folders/) — the folder contract and the convention model `design/` is a registered, optional instance of.
- [13-knowledge-format-okf.md](/workbench/knowledge-format-okf/) — OKF, the sibling convention for the architecture and wiki folders.
- [23-hooks-contract.md](/workbench/hooks-contract/) — the write-time lint that can check a design.md against its convention.
- [30-wiki.md](/workbench/wiki/) — the wiki as the search layer that indexes `design/`.
