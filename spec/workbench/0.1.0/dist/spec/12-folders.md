...
generated_from: "spec/workbench/0.1.0/draft/spec/12-folders.md"
generator: "scripts/generate-docs-payload.mjs"
edit_warning: "This file is auto-generated. Source: spec/workbench/0.1.0/draft/spec/12-folders.md."
---
...
| `.browser/` | Optional | Project | — | — | Browser-automation session, scripts, and output — only when the project does browser automation; `.browser/` is the canonical name, `.playwright/` a deprecated alias (see [31-browser-automation.md](/workbench/browser-automation/)). |
...
Browser automation is not universal. A project carries `.browser/` **only if** it actually performs browser automation; a project that does none **MUST NOT** be expected to have it. When present, the **canonical** name is `.browser/`; `.playwright/` is a **deprecated** alias kept for projects that have not yet migrated (no hard break — the migration runs at each project's own pace). The folder follows the normative conventions in [31-browser-automation.md](/workbench/browser-automation/).
