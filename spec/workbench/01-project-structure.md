...
| Related | [02-requirements.md](./02-requirements.md), [03-tools-registry.md](./03-tools-registry.md), [04-strands.md](./04-strands.md), [06-trash.md](./06-trash.md) |
...
| `.memo/` | Yes | Memos and their data siblings (`requirements/`, `tools/`); see [02-requirements.md](./02-requirements.md) and [03-tools-registry.md](./03-tools-registry.md). |
...
| `.wiki/` | Optional | LLM-generated project wiki (see [05-wiki.md](./05-wiki.md)). |
...
- [02-requirements.md](./02-requirements.md) — the `requirements/` sibling under `.memo/`.
- [03-tools-registry.md](./03-tools-registry.md) — the `tools/` sibling under `.memo/`.
