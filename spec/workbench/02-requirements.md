...
| Related | [03-tools-registry.md](./03-tools-registry.md), [04-strands.md](./04-strands.md), [00-overview.md](./00-overview.md) |
...
- [03-tools-registry.md](./03-tools-registry.md) — the parallel data folder describing available tools.
- [04-strands.md](./04-strands.md) — per-strand requirements draw from these profiles.
- [00-overview.md](./00-overview.md) — sub-spec scope and independent versioning.
