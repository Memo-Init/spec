...
|-------|-------|
| Status | Draft |
| Depends on | [02-requirements.md](./02-requirements.md), [03-tools-registry.md](./03-tools-registry.md) |
| Related | [01-project-structure.md](./01-project-structure.md), [00-overview.md](./00-overview.md) |
...
- [02-requirements.md](./02-requirements.md) — per-strand requirements draw from these profiles.
- [03-tools-registry.md](./03-tools-registry.md) — per-strand tools draw from this registry.
- [01-project-structure.md](./01-project-structure.md) — strands live inside a memo under `.memo/`.
