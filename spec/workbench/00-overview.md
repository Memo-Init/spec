...
This distinction is what [01-project-structure.md](./01-project-structure.md) makes concrete.
...
These checks are descriptive of the real audit performed at the workbench level; the normative details of the structure being checked live in [01-project-structure.md](./01-project-structure.md).
