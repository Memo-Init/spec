...
| Related | [05-config-cascade.md](./05-config-cascade.md), [07-doctor-init.md](./07-doctor-init.md), [workbench/20-cli.md](/workbench/cli/) |
...
- [05-config-cascade.md](./05-config-cascade.md) — the `.session/config.json` cascade and the `flag > env > config > default` precedence this chapter relies on.
- [07-doctor-init.md](./07-doctor-init.md) — the `doctor` / `init` verb contracts whose names this chapter reserves.
...
- [13-conventions.md](./13-conventions.md) — the `prefix-hyphen-name` naming convention this chapter references.
