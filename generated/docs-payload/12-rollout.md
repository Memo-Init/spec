...
|-------|-------|
| Status | Draft |
| Depends on | [11-quality-and-finalization.md](/specification/quality-and-finalization/) |
| Related | [13-orchestration.md](/specification/orchestration/), [14-agents-skills-tasks.md](/specification/agents-skills-tasks/), [16-git-security-versioning.md](/specification/git-security-versioning/), [00-overview.md](/specification/overview/) |
