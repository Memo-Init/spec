...
| `.wiki/` | Optional | LLM-generated project wiki; an OKF-conformant knowledge bundle (see [24-tools-registry.md](../v0.1.0/24-tools-registry.md) for its query role and [02-knowledge-format-okf.md](/specification/knowledge-format-okf/) for its on-disk format). |
