...
| Related | [02-requirements.md](/specification/requirements/), [03-tools-registry.md](/specification/tools-registry/), [04-strands.md](/specification/strands/), [06-trash.md](/specification/trash/) |

> Normative language (MUST/SHOULD/MAY) follows BCP 14 [RFC2119] [RFC8174]. RFC 2119 keywords are used.

This chapter is **normative** for the mandatory project layout, the local-only root, the single egress point, and the local guarantee.
...
| `.memo/` | Yes | Memos and their data siblings (`requirements/`, `tools/`); see [02-requirements.md](/specification/requirements/) and [03-tools-registry.md](/specification/tools-registry/). |
...
| `.wiki/` | Optional | LLM-generated project wiki (see [05-wiki.md](/specification/wiki/)). |
...
- [02-requirements.md](/specification/requirements/) — the `requirements/` sibling under `.memo/`.
- [03-tools-registry.md](/specification/tools-registry/) — the `tools/` sibling under `.memo/`.
