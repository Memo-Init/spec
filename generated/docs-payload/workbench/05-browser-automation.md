...
spec_version: "0.1.0"
spec_file: "05-browser-automation.md"
order: 5
section: "Workbench"
normative: true
generated_at: "2026-06-24T16:49:32.085Z"
generated_from: "spec/workbench/05-browser-automation.md"
generator: "scripts/generate-docs-payload.mjs"
edit_warning: "This file is auto-generated. Source: spec/workbench/05-browser-automation.md."
---
...
Browser automation lives at the project level. Each project carries its own `.playwright/` folder (see [01-project-structure.md](/specification/project-structure/)), its own session, and its own scripts. The conventions below are normative for that folder and for the tool-selection decisions a project makes.
...
- `auth.json` **MUST NOT** be committed. It belongs in `.gitignore`, and because the project root is local-only (see [01-project-structure.md](/specification/project-structure/)) it cannot leave the machine through `repos/` either.
...
- [00-overview.md](/specification/overview/) — the workbench sub-spec framing and the global helpers it exposes.
- [01-project-structure.md](/specification/project-structure/) — the `.playwright/` folder in the mandatory project layout, and the local guarantee that keeps `auth.json` and `output/` off the network.
...
- [06-trash.md](/specification/trash/) — why temporary scrape working material is removed through `.trash/` rather than hard-deleted.
