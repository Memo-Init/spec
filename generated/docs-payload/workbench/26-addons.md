...
- An add-on **MUST NOT** claim its own new top-level project folder for its data; the registered-folder contract flags an unexpected top-level entry for review ([12-folders.md](/specification/folders/)).
...
Every add-on follows the same four-part SOP — the common denominator the workbench skills already use ([24-skills-scope.md](/specification/skills-scope/)):
...
- [02-sop-entrypoint.md](/specification/sop-entrypoint/) — the Workbench-SOP that points at each add-on's SOP.
