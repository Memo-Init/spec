...
description: "This chapter is **normative** for the multi-repo coordination scope, the project-internal default, and the no-monorepo rule."
spec_version: "0.1.0"
...
This chapter is **normative** for the multi-repo coordination scope, the project-internal default, and the no-monorepo rule.
...
- The reason for the restriction is **context**: a memo that reaches across projects blurs the context it is reasoning in, and a blurred context is the precondition for contamination (see [13-orchestration.md](/specification/orchestration/) and the context-rot model). Keeping coordination project-internal keeps the context sharp.
