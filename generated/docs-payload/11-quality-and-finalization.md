...
|-------|-------|
| Status | Draft |
| Depends on | [10-proactive-research.md](/specification/proactive-research/) |
| Related | [12-rollout.md](/specification/rollout/), [09-contamination-context-handover.md](/specification/contamination-context-handover/), [16-git-security-versioning.md](/specification/git-security-versioning/), [00-overview.md](/specification/overview/) |
