...
|---|---|
| Status | Draft |
| Depends on | [06-memo-structure.md](/specification/memo-structure/) |
| Related | [04-input-pipeline.md](/specification/input-pipeline/), [11-quality-and-finalization.md](/specification/quality-and-finalization/), [14-agents-skills-tasks.md](/specification/agents-skills-tasks/) |
...
- [14-agents-skills-tasks.md](/specification/agents-skills-tasks/) — the authoring skills that the format fix targets.
