...
Related: [00-overview.md](/specification/overview/) (mission and authority model), [26-memo-history.md](/specification/memo-history/) (the cross-memo timeline a goal is read against); related primitives: [Memo](#memo), [Topic](#topic).
...
Related: [08-phases-and-prds.md](/specification/phases-and-prds/) (phases, `## Phase-Hints`, phase-planning lenses), [12-rollout.md](/specification/rollout/) (phase execution), [13-orchestration.md](/specification/orchestration/) (state model); related primitives: [PRD](#prd), [Strang](#strang), [Topic](#topic).
...
Related: [24-tools-registry.md](/specification/tools-registry/) (registry entries, checklist mechanic, wiki-as-a-tool), [23-requirements.md](/specification/requirements/) (tool-kind checks); related primitives: [Requirement](#requirement), [PRD](#prd), [Strang](#strang).
...
| Goal | Cross-memo intent that spans several memos and outlives any one. | [00-overview.md](/specification/overview/) |
...
| Strang | Emergent dependency closure over phases; a tag, not part of the memo ID. | [25-strands.md](/specification/strands/) |
...
- [25-strands.md](/specification/strands/) — the emergent strand primitive and the Tracer-Bullet decision.
