...
|-------|-------|
| Status | Draft |
| Depends on | [08-phases-and-prds.md](/specification/phases-and-prds/) |
| Related | [10-proactive-research.md](/specification/proactive-research/), [11-quality-and-finalization.md](/specification/quality-and-finalization/), [13-orchestration.md](/specification/orchestration/), [00-overview.md](/specification/overview/) |
...
> **Follow-up (specified, not yet implemented):** the `questions-json` hybrid that hardens the question format against the recurring LLM mis-format is specified in [07-revisions-and-questions.md](/specification/revisions-and-questions/); its live skill implementation is follow-up work, not part of the bootstrap.
...
- [11-quality-and-finalization.md](/specification/quality-and-finalization/) — the evidence levels (`[FAKT]` … `[UNBEKANNT]`) the handover zones reuse.
