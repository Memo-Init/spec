...
generated_from: "memo/0.3.0/draft/spec/09-contamination-context-handover.md"
generator: "scripts/generate-docs-payload.mjs"
edit_warning: "This file is auto-generated. Source: memo/0.3.0/draft/spec/09-contamination-context-handover.md."
---
...
Because the **Create** arc — authoring and the revision loop before finalization (defined in [02-memo-sop-entrypoint.md](/specification/memo-sop-entrypoint/)) — is interactive and inexpensive to redo, **abort and a fresh restart are always allowed**. When a Create session drifts (an overflowing context, an assumption that proved wrong), the sound response is to abort and begin again in a clean context rather than push a degraded memo toward finalization. This is the empty-context rule above applied to the interactive arc: the developer's judgement is spent during Create, and starting over costs little next to carrying contamination forward into the autonomous **Rollout** arc.
