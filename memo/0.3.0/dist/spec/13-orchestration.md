...
generated_from: "memo/0.3.0/draft/spec/13-orchestration.md"
generator: "scripts/generate-docs-payload.mjs"
edit_warning: "This file is auto-generated. Source: memo/0.3.0/draft/spec/13-orchestration.md."
---
...
- [14-agents-skills-tasks.md](/specification/agents-skills-tasks/) — the migration of the fresh-context evaluators to repo-scoped agents, and the **Non-Blocking User Thread** doctrine: rollout coordination MUST run off-thread (persistent agent / workflow runner), never in the host session; Task timing binds to the hand-off point.
