...
generated_from: "memo/0.2.0/draft/spec/14-agents-skills-tasks.md"
generator: "scripts/generate-docs-payload.mjs"
edit_warning: "This file is auto-generated. Source: memo/0.2.0/draft/spec/14-agents-skills-tasks.md."
---
...
| **Status observation** of a running rollout | external watcher on session/task files | No — read-only, outside the session (see [12-rollout.md](/specification/rollout/)) |
