---
title: "Plans"
description: "A **plan** was the primitive that sat above the memo and sequenced the work of one or more finalized memos into a single ordered run; it is now **deprecated** (see the banner above), and the..."
spec_version: "0.2.0"
...
> **Lifted into the rollout.** This is the one plan-layer capability the single-memo rollout did not already have, and it is **lifted out of the plan layer into the rollout** ([./12-rollout.md](/specification/rollout/)), where it couples to the five-hour cron mechanic. The description below is retained as the origin record of the mechanism; the live home of the wake-up is now the rollout.
...
- [./30-primitives.md](/specification/primitives/) — the eleven primitives, of which the plan is the one that spans many memos (now deprecated).
...
- [./12-rollout.md](/specification/rollout/) — the single-memo rollout that **supersedes** this deprecated layer; a rollout is a plan with one memo, and the budget wake-up is lifted there.
