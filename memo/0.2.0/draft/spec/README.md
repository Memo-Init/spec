# memo-init Specification — v0.2.0 (Draft)

This directory holds version `v0.2.0` of the memo-init specification, an RFC-style description of the memo system: a planning-first scaffold that turns long, dictated transcripts into discrete, executable work orders and governs the human-AI interaction around them.
