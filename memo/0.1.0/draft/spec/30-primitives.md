...
Related: [08-phases-and-prds.md](./08-phases-and-prds.md) (the canonical field set, the CLI contract, and the rollout single-checkability side); related primitives: [Topic](#topic), [Block](#block).
