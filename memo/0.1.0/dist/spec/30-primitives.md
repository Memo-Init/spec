...
Related: [08-phases-and-prds.md](/specification/phases-and-prds/) (the canonical field set, the CLI contract, and the rollout single-checkability side); related primitives: [Topic](#topic), [Block](#block).
