# 03. Navigation Categories

| Field | Value |
|---|---|
| Status | Draft |
| Depends on | [./02-per-chapter-format.md](./02-per-chapter-format.md) |
| Related | [./04-bridge-standard.md](./04-bridge-standard.md), [./00-overview.md](./00-overview.md) |
...
The family manifest ([Per-Chapter Format](./02-per-chapter-format.md)) carries a `groups[]` array. Each group is a category of chapters:
...
- [./02-per-chapter-format.md](./02-per-chapter-format.md) — the family head that carries the `groups[]` array.
- [./04-bridge-standard.md](./04-bridge-standard.md) — the bridge hub that mirrors these categories in its coverage view.
- [./00-overview.md](./00-overview.md) — the meta-specification entry point.
