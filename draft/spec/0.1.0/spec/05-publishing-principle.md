# 05. The Publishing Principle

| Field | Value |
|---|---|
| Status | Draft |
| Depends on | [./00-overview.md](./00-overview.md) |
| Related | [./04-bridge-standard.md](./04-bridge-standard.md), [./06-conventions-writing.md](./06-conventions-writing.md) |
...
The bridge computes a per-chapter **gaps roll-up** — where a skill's capability runs ahead of what a chapter specifies — and does **not** publish it ([The Bridge Standard](./04-bridge-standard.md)). This principle is the reason, and stating the reason correctly matters:
...
- [./04-bridge-standard.md](./04-bridge-standard.md) — the bridge withholds its gaps roll-up and provenance on the strength of this principle.
- [./06-conventions-writing.md](./06-conventions-writing.md) — how the organization's conventions are written and registered.
