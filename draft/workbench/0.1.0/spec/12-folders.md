...
| `.browser/` | Optional | Project | — | — | Browser-automation session, scripts, and output — only when the project does browser automation; `.browser/` is the canonical name, `.playwright/` a deprecated alias (see [31-browser-automation.md](./31-browser-automation.md)). |
