...
- [00-overview.md](./00-overview.md) — the session glossary this chapter's terms join.
- [02-enforcement.md](./02-enforcement.md) — the additive-and-reviewed discipline (REQ-SS-NOWRITE) applied in spirit to a memory-data migration.
- [12-instances.md](./12-instances.md) — the per-project instance model each memory store belongs to.
- [15-addons.md](./15-addons.md) — the Add-on data model this contrasts with: Add-on data lives in project folders, the memory store is the harness's own cross-session channel.
