...
generated_from: "session/0.3.0/draft/spec/02-enforcement.md"
generator: "scripts/generate-docs-payload.mjs"
edit_warning: "This file is auto-generated. Source: session/0.3.0/draft/spec/02-enforcement.md."
---
...
- [05-config-cascade.md](/session/config-cascade/) — the registry entry point and the `session init` migration that will move it from `.workbench/registry.json` to the session-tier `.session/config.json`.
