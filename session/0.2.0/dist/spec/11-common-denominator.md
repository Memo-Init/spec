...
generated_from: "session/0.2.0/draft/spec/11-common-denominator.md"
generator: "scripts/generate-docs-payload.mjs"
edit_warning: "This file is auto-generated. Source: session/0.2.0/draft/spec/11-common-denominator.md."
---
...
Setup, Health, and Update are the common denominator **of SOP shape** — the structure every SOP instance repeats. They are **not** a second "one big idea" competing with the session family's unifying principle. That single unifying idea is **Progressive Disclosure** ([00-overview.md](/session/overview/)): capability is drawn from a pool just-in-time, when its intent shows up, rather than held open all at once. The SOP common denominator is one **facet** of it — the predictable shape through which a tool's procedure is disclosed and made findable at the moment it is needed ([10-sop.md](/session/sop/)). Progressive Disclosure is the umbrella; the four-part common denominator is what that umbrella looks like at the SOP layer.
...
- [00-overview.md](/session/overview/) — Progressive Disclosure, the family's unifying principle; the SOP common denominator here is one facet of it.
