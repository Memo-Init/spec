...
| Related | [16-context.md](./16-context.md), [36-research.md](./36-research.md) |

`data/` is the project's **raw-input** folder: feeds and source material exactly as ingested, before any processing. It is the input side that `context/` is derived from. This page **owns** the `data/` specification; [12-folders.md](./12-folders.md) owns the raw/processed tier model.
...
- [16-context.md](./16-context.md) — the processed, derived side that `data/` feeds.
- [36-research.md](./36-research.md) — cloned foreign repositories, distinct from raw feeds.
- [12-folders.md](./12-folders.md) — the folder contract and the raw/processed tier model.
