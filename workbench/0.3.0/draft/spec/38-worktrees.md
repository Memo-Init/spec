...
| Related | [15-repos.md](./15-repos.md) |

`.worktrees/` is the **one consistent location** for a project's git worktrees — a dot-prefixed, gitignored area of generated checkouts with mandatory cleanup. This page owns the `.worktrees/` spec; [12-folders.md](./12-folders.md) owns the dot/no-dot machinery rule.
...
- [15-repos.md](./15-repos.md) — the repositories a worktree is a checkout of.
- [12-folders.md](./12-folders.md) — the folder contract and the dot/no-dot machinery rule.
