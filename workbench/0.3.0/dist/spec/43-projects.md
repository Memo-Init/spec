---
title: "projects/"
description: "`projects/` is the workbench root's **container of all projects** — one directory per project, each carrying its own project-level structure. It is a mandatory ROOT-level folder (a workbench root..."
workbench_version: "0.3.0"
spec_file: "43-projects.md"
order: 43
section: "Workbench"
normative: true
generated_at: "2026-07-17T23:43:43.034Z"
generated_from: "workbench/0.3.0/draft/spec/43-projects.md"
generator: "scripts/generate-docs-payload.mjs"
edit_warning: "This file is auto-generated. Source: workbench/0.3.0/draft/spec/43-projects.md."
---


`projects/` is the workbench root's **container of all projects** — one directory per project, each carrying its own project-level structure. It is a mandatory ROOT-level folder (a workbench root MUST provide it, [10-root-and-projects.md](/workbench/root-and-projects/)), and it is easy to overlook precisely because it is where all the actual work then lives. This page owns the `projects/` spec; [10-root-and-projects.md](/workbench/root-and-projects/) owns the root-vs-project boundary.
...
- [10-root-and-projects.md](/workbench/root-and-projects/) — the root-vs-project boundary and the root inventory.
- [11-project-structure.md](/workbench/project-structure/) — the local guarantee protecting both levels.
- [12-folders.md](/workbench/folders/) — the per-project folder contract each `projects/<name>/` follows.
