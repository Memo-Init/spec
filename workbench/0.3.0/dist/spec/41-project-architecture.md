...
flowchart TD
    ...
    subgraph SPECS["Workshop spec/ container — four sibling spec families (promoted to repos/spec)"]
        direction TB
        MI["memo-init spec<br/>memo/0.3.0/draft/spec/"]
        WBS["Workbench spec<br/>workbench/0.3.0/draft/spec/<br/>Introduction · Folders · CLI"]
        SOPF["Session spec<br/>session/0.3.0/draft/spec/<br/>carries the SOP area — connects the SOPs"]
        META["Meta-spec<br/>spec/0.3.0/draft/spec/<br/>the per-chapter format every family follows"]
